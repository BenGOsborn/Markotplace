...
- THE VERSION SHOULD ONLY EVER BE UPDATED VIA THE WEBHOOK WHEN THE REPO CHANGES OTHERWISE THE BUILD WILL STAY THE SAME I BELIEVE - AND SOMETIMES IT WONT EVEN WORK PROPERLY IF A FILE FROM THE DOCKER BUILD IS NOT CHANGED BY THE CACHE (I could remove the cache from Docker or reset it everytime to fix this issue ?)
