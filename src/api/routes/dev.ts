...
router.get("/authorize/github", async (req, res) => {
    ...
    const redirectURL = `https://github.com/login/oauth/authorize?client_id=${process.env.GITHUB_CLIENT_ID}&scope=repo&redirect_uri=https://${process.env.FRONTEND_ADDRESS}/user/dev/authorize-github`;
